...
describe("verification animation", () => {
  ...
  it("keeps the enlarged visible area within the readability range", () => {
    ...
    expect(reduceGlyphVisibility(0.34, 0)).toBeCloseTo(0.20778);
    expect(reduceGlyphVisibility(0.56, 1)).toBeCloseTo(0.4);
    expect(reduceGlyphVisibility(0.5, 0.5)).toBeCloseTo(0.33056);
  });
