(function () {
  ...
  var translations = {
    en: {
      ...
      demoEyebrow: "CAPTCHA MODULES", demoTitle: "Choose a verification.", demoLead: "Gravity presents four distorted characters in a static image. Horizon reveals information through a GIF animation. Both use the same integration and server-side verification flow.", liveDemo: "LIVE DEMO", tryNexa: "Try NexaCAPTCHA Horizon", tryGravity: "Try NexaCAPTCHA Gravity", ready: "Ready", demoHelp: "Follow each color through the animation. Enter the four characters when you're ready.", gravityHelp: "Read the four hollow characters in the distorted image, then enter them below.", openHorizonDemo: "Open the full Horizon demo", openGravityDemo: "Open the full Gravity demo", demoOutput: "Your result will appear here.",
    ...
    "zh-Hant": {
      ...
      experimentEyebrow: "驗證測試", experimentTitle: "驗證效能，實際量測。", experimentLead: "Horizon 測試中的 Agent 沒有先前嘗試或上下文；它在測試當下才撰寫分析腳本，並在過程中逐步改進。", experimentVersion: "測試版本", experimentHumanLabel: "真人", verificationSystem: "驗證系統", secondsAverage: "秒平均完成", successRate: "成功率", experimentNote: "這些數據僅描述已記錄的測試，不保證所有模型或每次執行都會得到相同結果。",
    ...
    ja: {
      ...
      experimentEyebrow: "検証テスト", experimentTitle: "認証性能を実測。", experimentLead: "Horizonのテストでは、Agentは事前の試行やコンテキストなしで開始し、その場で分析スクリプトを作成してテスト中に改善しました。", experimentVersion: "テスト版", experimentHumanLabel: "人", verificationSystem: "認証システム", secondsAverage: "秒（平均）", successRate: "成功率", experimentNote: "記載値は実施したテストの結果であり、すべてのモデルや実行に対する性能を保証するものではありません。",
  ...
  Object.assign(translations["zh-Hant"], {
    ...
    experimentLead: "Horizon 測試中的 Agent 沒有先前嘗試或上下文；它在測試當下才撰寫分析腳本，並在過程中逐步改進。",
    navDemo: "示範",
    navCallback: "串接",
    tryIt: "查看 CAPTCHA 模組",
    demoEyebrow: "CAPTCHA 模組",
    demoTitle: "選擇驗證方式。",
    demoLead: "Gravity 以靜態圖片呈現四個扭曲字元；Horizon 則透過 GIF 動畫呈現資訊。兩者共用相同的串接格式與後端驗證流程。",
  ...
  Object.assign(translations.ja, {
    ...
    experimentLead: "Horizonのテストでは、Agentは事前の試行やコンテキストなしで開始し、その場で分析スクリプトを作成してテスト中に改善しました。",
    navDemo: "デモ",
    navCallback: "導入",
    tryIt: "CAPTCHAモジュールを見る",
    demoEyebrow: "CAPTCHA MODULES",
    demoTitle: "認証方式を選択。",
    demoLead: "Gravityは静止画像で歪んだ4文字を表示し、HorizonはGIFアニメーションで情報を示します。どちらも同じ導入形式とサーバー検証フローを使用します。",
