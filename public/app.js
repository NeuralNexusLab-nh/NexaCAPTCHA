(function () {
  ...
  var translations = {
    ...
    "zh-Hant": {
      ...
      tryIt: "開啟示範", addToSite: "查看串接方式", noCleanFrame: "以真人可讀性為優先", changingMotion: "Horizon 測試中模型成功率 11.8%", higherCost: "兩次輸入機會，之後失效",
    ...
    ja: {
      ...
      tryIt: "デモを開く", addToSite: "導入方法を見る", noCleanFrame: "人の読みやすさを優先", changingMotion: "Horizonテストでのモデル成功率11.8%", higherCost: "入力は2回まで",
  ...
  Object.assign(translations["zh-Hant"], {
    ...
    experimentLead: "Agent 在有限度的前期熟悉後接受測試；可先了解驗證流程，但沒有取得實作細節或專用訓練資料。",
    navDemo: "示範",
    navCallback: "串接",
    tryIt: "查看 CAPTCHA 模組",
  ...
  Object.assign(translations.ja, {
    ...
    experimentLead: "Agentは認証フローを短時間かつ限定的に確認した後で評価され、実装の詳細やタスク専用の学習データにはアクセスしていません。",
    navDemo: "デモ",
    navCallback: "導入",
