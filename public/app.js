(function () {
  ...
  var translations = {
    en: {
      ...
      heroEyebrow: "ADAPTIVE HUMAN VERIFICATION", heroTitleLine1: "Homo Sapiens? Welcome onboard!", heroTitleLine2: "AI? Get out!", heroLead: "NexaCAPTCHA keeps verification clear for legitimate users while increasing the time, computation, and uncertainty required for automated solving.",
    ...
    "zh-Hant": {
      ...
      heroEyebrow: "自適應人機驗證", heroTitleLine1: "Homo Sapiens? Welcome onboard!", heroTitleLine2: "AI? Get out!", heroLead: "NexaCAPTCHA 讓正常使用者清楚完成驗證，同時提高自動化解題所需的時間、運算與不確定性。",
    ...
    ja: {
      ...
      heroEyebrow: "適応型ヒューマン認証", heroTitleLine1: "Homo Sapiens? Welcome onboard!", heroTitleLine2: "AI? Get out!", heroLead: "NexaCAPTCHA は正規ユーザーの分かりやすさを保ちながら、自動解読に必要な時間、計算量、不確実性を高めます。",
