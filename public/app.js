(function () {
  ...
  var translations = {
    en: {
      ...
      experimentEyebrow: "SMALL-SCALE TEST", experimentTitle: "Fast for people. Expensive for AI.", experimentLead: "The same model was tested with and without a strategy learned from earlier attempts.", experimentVersion: "Current CAPTCHA", experimentHumanLabel: "Human", experimentSeconds: "s average", experimentHumanMeta: "Average completion time", experimentColdLabel: "GPT 5.6 Sol - Medium · No experience", experimentSuccess: "success", experimentColdMeta: "No prior solving strategy · 4 of 4 expired after 5 minutes", experimentWarmLabel: "GPT 5.6 Sol - Medium · Experienced", experimentAverage: "average", experimentWarmMeta: "Used a strategy learned from earlier solves · 3 of 3 succeeded · 2 incorrect attempts on average", comparisonEyebrow: "SAME MODEL · GOOGLE RECAPTCHA", comparisonTitle: "A familiar image test was faster. The checkbox asked nothing.", comparisonModel: "GPT 5.6 Sol - Medium", comparisonImageTitle: "Image challenge", comparisonImageMeta: "About 1:30 · passed on the first answer", comparisonCheckboxTitle: "Checkbox", comparisonCheckboxMeta: "Passed directly · no image challenge shown", experimentNote: "A documented small-scale test of the current version. Results describe these runs and are not a security guarantee.",
    ...
    "zh-Hant": {
      ...
      experimentEyebrow: "正式小型測試", experimentTitle: "人類快速完成，AI 付出高昂成本。", experimentLead: "相同模型分別在沒有策略與從先前嘗試學到策略的情況下接受測試。", experimentVersion: "目前版本", experimentHumanLabel: "人類", experimentSeconds: "秒平均", experimentHumanMeta: "平均完成時間", experimentColdLabel: "GPT 5.6 Sol - Medium · 無經驗", experimentSuccess: "成功率", experimentColdMeta: "沒有先前解題策略 · 4 次測試全部在 5 分鐘後失效", experimentWarmLabel: "GPT 5.6 Sol - Medium · 有經驗", experimentAverage: "平均", experimentWarmMeta: "使用從先前解題摸索出的策略 · 3 次全部成功 · 平均錯誤 2 次", comparisonEyebrow: "相同模型 · GOOGLE RECAPTCHA", comparisonTitle: "熟悉的圖片題更快，勾選框甚至沒有出題。", comparisonModel: "GPT 5.6 Sol - Medium", comparisonImageTitle: "圖片驗證", comparisonImageMeta: "約 1 分 30 秒 · 第一次作答成功", comparisonCheckboxTitle: "勾選框", comparisonCheckboxMeta: "直接通過 · 沒有出現圖片驗證", experimentNote: "這是目前版本有紀錄的正式小型測試；結果只描述這些測試，不代表安全保證。",
    ...
    ja: {
      ...
      experimentEyebrow: "正式な小規模テスト", experimentTitle: "人には速く、AI には高コスト。", experimentLead: "同じモデルを、事前戦略なしの場合と過去の試行から学んだ戦略ありの場合でテストしました。", experimentVersion: "現在の CAPTCHA", experimentHumanLabel: "人間", experimentSeconds: "秒（平均）", experimentHumanMeta: "平均完了時間", experimentColdLabel: "GPT 5.6 Sol - Medium · 未経験", experimentSuccess: "成功率", experimentColdMeta: "事前の解答戦略なし · 4回すべて5分後に期限切れ", experimentWarmLabel: "GPT 5.6 Sol - Medium · 経験あり", experimentAverage: "平均", experimentWarmMeta: "過去の解答から得た戦略を使用 · 3回すべて成功 · 平均2回不正解", comparisonEyebrow: "同一モデル · GOOGLE RECAPTCHA", comparisonTitle: "一般的な画像問題は速く、チェックボックスでは問題すら出ませんでした。", comparisonModel: "GPT 5.6 Sol - Medium", comparisonImageTitle: "画像チャレンジ", comparisonImageMeta: "約1分30秒 · 1回目で成功", comparisonCheckboxTitle: "チェックボックス", comparisonCheckboxMeta: "そのまま通過 · 画像問題なし", experimentNote: "現在版について記録した正式な小規模テストです。結果は今回の試行のみを示し、安全性を保証するものではありません。",
