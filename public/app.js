(function () {
  ...
  var translations = {
    en: {
      ...
      demoEyebrow: "LIVE VERIFICATION", demoTitle: "Try Gravity.", demoLead: "Gravity presents four distorted characters in a static image and uses the same server-side verification flow shown below.", liveDemo: "LIVE DEMO", tryGravity: "Try NexaCAPTCHA Gravity", ready: "Ready", gravityHelp: "Read the four hollow characters in the distorted image, then enter them below.", openGravityDemo: "Open the full Gravity demo", demoOutput: "Your result will appear here.",
      integrationButtonTitle: "Integrate NexaCAPTCHA", integrationButtonLead: "Add Gravity to your site.", moduleLoadersTitle: "Frontend loader", gravityLoader: "Gravity loader",
  ...
  Object.assign(translations["zh-Hant"], {
    ...
    demoEyebrow: "即時驗證",
    demoTitle: "試用 Gravity。",
    demoLead: "Gravity 以靜態圖片呈現四個扭曲字元，並使用下方說明的後端驗證流程。",
    integrationButtonTitle: "串接 NexaCAPTCHA",
    integrationButtonLead: "將 Gravity 加入你的網站。",
  ...
  Object.assign(translations.ja, {
    ...
    demoEyebrow: "ライブ認証",
    demoTitle: "Gravityを試す。",
    demoLead: "Gravityは静止画像で歪んだ4文字を表示し、以下のサーバー検証フローを使用します。",
    integrationButtonTitle: "NexaCAPTCHAを導入",
    integrationButtonLead: "Gravityをサイトに追加します。",
