(function () {
  ...
  var translations = {
    en: {
      ...
      availabilityTitle: "Hosted service availability", availabilityBody: "The hosted NexaCAPTCHA service is provided as is, without any guarantee of uninterrupted or permanent availability. If the website or service is interrupted, discontinued, or becomes unavailable, NexaCAPTCHA and NeuralNexusLab accept no liability and provide no compensation for resulting loss or damage.",
    ...
    "zh-Hant": {
      ...
      tryIt: "開啟示範", addToSite: "查看串接方式", noCleanFrame: "以真人可讀性為優先", changingMotion: "Gravity 測試中模型成功率 17.6%", higherCost: "兩次輸入機會，之後失效",
      liveDemo: "即時示範", tryNexa: "試用 NexaCAPTCHA", ready: "可以開始", demoHelp: "跟著每個顏色看完整段動畫，準備好後輸入四個字元。", demoOutput: "驗證結果會顯示在這裡。",
      availabilityTitle: "託管服務可用性", availabilityBody: "官方託管的 NexaCAPTCHA 服務依現況提供，不保證不中斷或永久營運。若網站或服務中斷、終止或無法使用，NexaCAPTCHA 與 NeuralNexusLab 不對因此造成的任何損失或損害負責，亦不提供賠償。",
      featuresEyebrow: "運作方式", featuresTitle: "兼顧安全性與可用性。", featuresLead: "NexaCAPTCHA 將視覺資訊分散在時間序列中。真人能依循清楚的變化完成驗證；自動化系統則必須從多個影格重建答案。",
      experimentEyebrow: "驗證測試", experimentTitle: "驗證效能，實際量測。", experimentLead: "所有 Agent 都在沒有既有上下文的情況下開始，並於測試中逐步摸索解法。", experimentVersion: "測試版本", experimentHumanLabel: "真人", verificationSystem: "驗證系統", secondsAverage: "秒平均完成", successRate: "成功率", experimentNote: "這些數據僅描述已記錄的測試，不保證所有模型或每次執行都會得到相同結果。",
      ...
      copy: "複製", copied: "已複製", copySuccess: "程式碼已複製。", copyFailure: "無法複製，請手動選取。", completed: "驗證完成", footerTagline: "結合扭曲文字與伺服器控管的人機驗證。"
    },
    ja: {
      ...
      tryIt: "デモを開く", addToSite: "導入方法を見る", noCleanFrame: "人の読みやすさを優先", changingMotion: "Gravityテストでのモデル成功率17.6%", higherCost: "入力は2回まで",
      liveDemo: "ライブデモ", tryNexa: "NexaCAPTCHA を試す", ready: "準備完了", demoHelp: "色ごとに動きを追い、分かった4文字を入力してください。", demoOutput: "認証結果がここに表示されます。",
      availabilityTitle: "ホストサービスの提供について", availabilityBody: "公式ホスト版NexaCAPTCHAは現状有姿で提供され、継続的または永続的な利用を保証しません。ウェブサイトまたはサービスが中断、終了、利用不能となった場合、NexaCAPTCHAおよびNeuralNexusLabは、それにより生じた損失または損害について責任を負わず、補償も行いません。",
      ...
      experimentEyebrow: "検証テスト", experimentTitle: "認証性能を実測。", experimentLead: "すべてのAgentは事前コンテキストなしで開始し、テスト中に解法を組み立てました。", experimentVersion: "テスト版", experimentHumanLabel: "人", verificationSystem: "認証システム", secondsAverage: "秒（平均）", successRate: "成功率", experimentNote: "記載値は実施したテストの結果であり、すべてのモデルや実行に対する性能を保証するものではありません。",
      ...
      copy: "コピー", copied: "コピー済み", copySuccess: "コードをコピーしました。", copyFailure: "コピーできませんでした。手動で選択してください。", completed: "認証完了", footerTagline: "歪み文字とサーバー制御を組み合わせた本人確認。"
    }
  };
  ...
  Object.assign(translations["zh-Hant"], {
    ...
    navDemo: "示範",
    navCallback: "串接",
    tryIt: "試用 NexaCAPTCHA",
    demoEyebrow: "CAPTCHA 模組",
    demoTitle: "可用的驗證方式。",
    integrationButtonTitle: "使用官方託管服務",
    integrationButtonLead: "透過官方前端載入程式加入 NexaCAPTCHA。",
    selfHostButtonTitle: "自行部署 NexaCAPTCHA",
  ...
  Object.assign(translations.ja, {
    ...
    navDemo: "デモ",
    navCallback: "導入",
    tryIt: "NexaCAPTCHAを試す",
    demoEyebrow: "CAPTCHAモジュール",
    demoTitle: "利用可能な認証。",
    integrationButtonTitle: "公式ホスト版を利用",
    integrationButtonLead: "公式ローダーでNexaCAPTCHAを追加します。",
    selfHostButtonTitle: "NexaCAPTCHAをセルフホスト",
