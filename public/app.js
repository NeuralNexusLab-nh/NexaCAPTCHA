(function () {
  ...
  var translations = {
    en: {
      skip: "Skip to content", languageLabel: "Language", navTop: "Top", navDemo: "Demo", navFeatures: "Features", navExperiment: "Experiment", navSetup: "Setup", navVerify: "Check the result",
      ...
      experimentEyebrow: "SMALL-SCALE TEST", experimentTitle: "Fast for people. Expensive for AI.", experimentLead: "The same model was tested with and without a strategy learned from earlier attempts.", experimentVersion: "Tested build", experimentHumanLabel: "Human", experimentSeconds: "s average", experimentHumanMeta: "Average completion time", experimentColdLabel: "GPT 5.6 Sol - Medium · No experience", experimentSuccess: "success", experimentColdMeta: "No prior solving strategy", experimentWarmLabel: "GPT 5.6 Sol - Medium · Experienced", experimentAverage: "average", experimentWarmMeta: "Used a strategy learned from earlier solves", comparisonEyebrow: "SAME MODEL · GOOGLE RECAPTCHA", comparisonTitle: "A familiar image test was faster. The checkbox asked nothing.", comparisonModel: "GPT 5.6 Sol - Medium", comparisonImageTitle: "Image challenge", comparisonImageMeta: "About 1:30 · passed on the first answer", comparisonCheckboxTitle: "Checkbox", comparisonCheckboxMeta: "Passed directly · no image challenge shown", experimentNote: "A documented small-scale test of the tested build. Results describe these runs and are not a security guarantee.",
      featureIncompleteTitle: "No complete frame", featureIncompleteBody: "No single frame contains a complete, directly readable character. Only the full animation scans every part.", featureDistortionTitle: "Constant distortion", featureDistortionBody: "Characters keep bending, stretching, rotating, and changing shape.", featureMotionTitle: "Independent movement", featureMotionBody: "Every character moves in its own direction and at its own changing speed.", featureWindowTitle: "An unpredictable window", featureWindowBody: "The visible shape keeps bending and changing while it speeds up, slows down, and moves backward.", featureUniqueTitle: "Different every time", featureUniqueBody: "Animation length, fixed character colors, motion, distortion, and timing change with every CAPTCHA.", featureCostTitle: "Higher solving cost", featureCostBody: "Bots must inspect many frames, track moving fragments, and rebuild the answer instead of reading one image.",
    ...
    "zh-Hant": {
      skip: "跳到主要內容", languageLabel: "語言", navTop: "頂端", navDemo: "示範", navFeatures: "特點", navExperiment: "實驗", navSetup: "串接", navVerify: "檢查結果",
      ...
      experimentEyebrow: "正式小型測試", experimentTitle: "人類快速完成，AI 付出高昂成本。", experimentLead: "相同模型分別在沒有策略與從先前嘗試學到策略的情況下接受測試。", experimentVersion: "測試版本", experimentHumanLabel: "人類", experimentSeconds: "秒平均", experimentHumanMeta: "平均完成時間", experimentColdLabel: "GPT 5.6 Sol - Medium · 無經驗", experimentSuccess: "成功率", experimentColdMeta: "沒有先前解題策略", experimentWarmLabel: "GPT 5.6 Sol - Medium · 有經驗", experimentAverage: "平均", experimentWarmMeta: "使用從先前解題摸索出的策略", comparisonEyebrow: "相同模型 · GOOGLE RECAPTCHA", comparisonTitle: "熟悉的圖片題更快，勾選框甚至沒有出題。", comparisonModel: "GPT 5.6 Sol - Medium", comparisonImageTitle: "圖片驗證", comparisonImageMeta: "約 1 分 30 秒 · 第一次作答成功", comparisonCheckboxTitle: "勾選框", comparisonCheckboxMeta: "直接通過 · 沒有出現圖片驗證", experimentNote: "這是測試版本有紀錄的正式小型測試；結果只描述這些測試，不代表安全保證。",
      featureIncompleteTitle: "沒有完整畫面", featureIncompleteBody: "沒有任何一幀包含完整、可直接讀取的字元；只有看完整段動畫才會掃過所有部分。", featureDistortionTitle: "持續扭曲", featureDistortionBody: "字元會不斷彎曲、拉伸、旋轉和改變形狀。", featureMotionTitle: "各自獨立移動", featureMotionBody: "每個字元都有自己的方向和持續改變的速度。", featureWindowTitle: "難以預測的窗口", featureWindowBody: "可見形狀會持續彎曲和改變，同時加速、減速和倒退。", featureUniqueTitle: "每次都不一樣", featureUniqueBody: "每次 CAPTCHA 的動畫長度、固定字色、移動、扭曲和時機都會改變。", featureCostTitle: "大幅提高破解成本", featureCostBody: "Bot 不能只讀一張圖片，而必須檢查許多畫面、追蹤片段並重組答案。",
    ...
    ja: {
      skip: "メインコンテンツへ移動", languageLabel: "言語", navTop: "トップ", navDemo: "デモ", navFeatures: "特徴", navExperiment: "実験", navSetup: "導入", navVerify: "結果を確認",
      ...
      experimentEyebrow: "正式な小規模テスト", experimentTitle: "人には速く、AI には高コスト。", experimentLead: "同じモデルを、事前戦略なしの場合と過去の試行から学んだ戦略ありの場合でテストしました。", experimentVersion: "テスト版", experimentHumanLabel: "人間", experimentSeconds: "秒（平均）", experimentHumanMeta: "平均完了時間", experimentColdLabel: "GPT 5.6 Sol - Medium · 未経験", experimentSuccess: "成功率", experimentColdMeta: "事前の解答戦略なし", experimentWarmLabel: "GPT 5.6 Sol - Medium · 経験あり", experimentAverage: "平均", experimentWarmMeta: "過去の解答から得た戦略を使用", comparisonEyebrow: "同一モデル · GOOGLE RECAPTCHA", comparisonTitle: "一般的な画像問題は速く、チェックボックスでは問題すら出ませんでした。", comparisonModel: "GPT 5.6 Sol - Medium", comparisonImageTitle: "画像チャレンジ", comparisonImageMeta: "約1分30秒 · 1回目で成功", comparisonCheckboxTitle: "チェックボックス", comparisonCheckboxMeta: "そのまま通過 · 画像問題なし", experimentNote: "テスト版について記録した正式な小規模テストです。結果は今回の試行のみを示し、安全性を保証するものではありません。",
      featureIncompleteTitle: "完全なフレームなし", featureIncompleteBody: "完全でそのまま読める文字を含むフレームはなく、アニメーション全体ですべての部分を走査します。", featureDistortionTitle: "変化し続ける歪み", featureDistortionBody: "文字は曲がり、伸び、回転し、形を変え続けます。", featureMotionTitle: "独立した動き", featureMotionBody: "各文字は独自の方向と変化する速度で動きます。", featureWindowTitle: "予測しにくい表示窓", featureWindowBody: "表示形状は曲がり続け、加速、減速、後退しながら変化します。", featureUniqueTitle: "毎回異なる", featureUniqueBody: "アニメーション時間、固定文字色、動き、歪み、タイミングが CAPTCHA ごとに変わります。", featureCostTitle: "解読コストを大幅に増加", featureCostBody: "Bot は一枚の画像では足りず、多数の画面を調べ、断片を追跡して答えを再構成します。",
