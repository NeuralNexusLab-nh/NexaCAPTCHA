(function () {
  ...
  var translations = {
    en: {
      ...
      experimentEyebrow: "SMALL EXPERIMENT", experimentTitle: "Humans finished. GPT timed out.", experimentVersion: "Current CAPTCHA", experimentHumanLabel: "Human", experimentSeconds: "s average", experimentHumanMeta: "5 trials · 8–15 seconds", experimentExpired: "Expired", experimentGptMeta: "1 trial · 4 incorrect attempts · timed out after 5 minutes", experimentNote: "A small informal test of the current version, not a security guarantee. More trials will be added.",
    ...
    "zh-Hant": {
      ...
      experimentEyebrow: "小型實驗", experimentTitle: "人類完成了，GPT 超時了。", experimentVersion: "目前版本", experimentHumanLabel: "人類", experimentSeconds: "秒平均", experimentHumanMeta: "5 次測試 · 8–15 秒", experimentExpired: "已失效", experimentGptMeta: "1 次測試 · 錯誤 4 次 · 5 分鐘後超時", experimentNote: "這是目前版本的小型非正式測試，不代表安全保證；之後會加入更多測試。",
    ...
    ja: {
      ...
      experimentEyebrow: "小規模テスト", experimentTitle: "人は完了。GPT はタイムアウト。", experimentVersion: "現在の CAPTCHA", experimentHumanLabel: "人間", experimentSeconds: "秒（平均）", experimentHumanMeta: "5回 · 8～15秒", experimentExpired: "期限切れ", experimentGptMeta: "1回 · 4回不正解 · 5分後にタイムアウト", experimentNote: "現在版での小規模な非公式テストであり、安全性を保証するものではありません。今後さらに試行を追加します。",
