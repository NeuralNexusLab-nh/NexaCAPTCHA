(function () {
  ...
  var translations = {
    en: {
      ...
      availabilityTitle: "Hosted service availability", availabilityBody: "The hosted NexaCAPTCHA service is provided as is, without any guarantee of uninterrupted or permanent availability. If the website or service is interrupted, discontinued, or becomes unavailable, NexaCAPTCHA and NXLabTW accept no liability and provide no compensation for resulting loss or damage.",
    ...
    "zh-Hant": {
      ...
      availabilityTitle: "託管服務可用性", availabilityBody: "官方託管的 NexaCAPTCHA 服務依現況提供，不保證不中斷或永久營運。若網站或服務中斷、終止或無法使用，NexaCAPTCHA 與 NXLabTW 不對因此造成的任何損失或損害負責，亦不提供賠償。",
    ...
    ja: {
      ...
      availabilityTitle: "ホストサービスの提供について", availabilityBody: "公式ホスト版NexaCAPTCHAは現状有姿で提供され、継続的または永続的な利用を保証しません。ウェブサイトまたはサービスが中断、終了、利用不能となった場合、NexaCAPTCHAおよびNXLabTWは、それにより生じた損失または損害について責任を負わず、補償も行いません。",
