(function () {
  ...
  var translations = {
    en: {
      ...
      featureReadableTitle: "Clearer for people", featureReadableBody: "Characters stay upright while drifting smoothly in different directions.", featureMotionTitle: "The full animation matters", featureMotionBody: "No single moment shows the complete answer. Automated tools must inspect more than one image.", featureSimpleTitle: "Simple to add", featureSimpleBody: "Load one script, add one element, then verify two values from your backend.",
    ...
    "zh-Hant": {
      ...
      featureReadableTitle: "人類更容易閱讀", featureReadableBody: "字元保持正向，並平滑地往不同方向漂移。", featureMotionTitle: "需要觀看動畫", featureMotionBody: "任何單一畫面都不會顯示完整答案，自動化工具必須檢查多個畫面。", featureSimpleTitle: "容易加入網站", featureSimpleBody: "載入一個 Script、加入一個元素，再由後端驗證兩個值。",
    ...
    ja: {
      ...
      featureReadableTitle: "人が読みやすい", featureReadableBody: "文字は正しい向きを保ち、さまざまな方向へ滑らかに移動します。", featureMotionTitle: "アニメーション全体が必要", featureMotionBody: "一画面だけでは答え全体が見えないため、自動化ツールは複数の画面を確認する必要があります。", featureSimpleTitle: "簡単に追加", featureSimpleBody: "Script と要素を一つずつ追加し、バックエンドで二つの値を確認します。",
