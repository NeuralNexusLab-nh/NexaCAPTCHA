(function () {
  ...
  var translations = {
    en: {
      ...
      featureIncompleteTitle: "Incomplete by design", featureIncompleteBody: "A frame never exposes more than 40% of any one character.", featureDistortionTitle: "Constant distortion", featureDistortionBody: "Characters keep bending, stretching, rotating, and changing shape.", featureMotionTitle: "Independent movement", featureMotionBody: "Every character moves in its own direction and at its own changing speed.", featureWindowTitle: "An unpredictable window", featureWindowBody: "The visible shape keeps bending and changing while it speeds up, slows down, and moves backward.", featureUniqueTitle: "Different every time", featureUniqueBody: "Animation length, color, motion, distortion, and timing change with every CAPTCHA.", featureCostTitle: "Higher solving cost", featureCostBody: "Bots must inspect many frames, track moving fragments, and rebuild the answer instead of reading one image.",
    ...
    "zh-Hant": {
      ...
      featureIncompleteTitle: "刻意保持不完整", featureIncompleteBody: "任何一幀都不會顯示單一字元超過 40% 的筆畫。", featureDistortionTitle: "持續扭曲", featureDistortionBody: "字元會不斷彎曲、拉伸、旋轉和改變形狀。", featureMotionTitle: "各自獨立移動", featureMotionBody: "每個字元都有自己的方向和持續改變的速度。", featureWindowTitle: "難以預測的窗口", featureWindowBody: "可見形狀會持續彎曲和改變，同時加速、減速和倒退。", featureUniqueTitle: "每次都不一樣", featureUniqueBody: "每次 CAPTCHA 的動畫長度、顏色、移動、扭曲和時機都會改變。", featureCostTitle: "大幅提高破解成本", featureCostBody: "Bot 不能只讀一張圖片，而必須檢查許多畫面、追蹤片段並重組答案。",
    ...
    ja: {
      ...
      featureIncompleteTitle: "意図的に不完全", featureIncompleteBody: "どのフレームでも、1文字の筆画は40%を超えて表示されません。", featureDistortionTitle: "変化し続ける歪み", featureDistortionBody: "文字は曲がり、伸び、回転し、形を変え続けます。", featureMotionTitle: "独立した動き", featureMotionBody: "各文字は独自の方向と変化する速度で動きます。", featureWindowTitle: "予測しにくい表示窓", featureWindowBody: "表示形状は曲がり続け、加速、減速、後退しながら変化します。", featureUniqueTitle: "毎回異なる", featureUniqueBody: "アニメーション時間、色、動き、歪み、タイミングが CAPTCHA ごとに変わります。", featureCostTitle: "解読コストを大幅に増加", featureCostBody: "Bot は一枚の画像では足りず、多数の画面を調べ、断片を追跡して答えを再構成します。",
